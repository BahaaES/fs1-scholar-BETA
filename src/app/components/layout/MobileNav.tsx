          ...
          <div className="md:hidden">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                {isAdmin && (
                  <Link href="/admin" onClick={() => setIsProfileOpen(false)} className="w-full flex items-center gap-4 p-4 bg-amber-400/10 text-amber-400 rounded-2xl font-bold transition-all">
                    <ShieldCheck size={20} /> 
                ...
                <button onClick={handleSignOut} className="w-full flex items-center gap-4 p-4 bg-red-500/10 text-red-500 rounded-2xl font-bold transition-all">
                  <LogOut size={20} /> 
